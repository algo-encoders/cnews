<?php cnews_header(); ?>
      <!--====== MAIN PART START ======-->
      <main>
         <!--====== BLOG POST INTRO START ======-->
         <section id="privacy">
         <center>
         <div class="thecuratedflow_img_area">
                        <img src="./static/images/topblog.png" alt="top" class="img-fluid">
                     </div>
                     </center>
            <div class="container">
               <div class="privacy_wrap">
                  <div class="row">
                     <div class="col-12">
                        ...
                        <h1>The Curated News Blogger</h1>
                        <br></br>
                        <p>Our blog is a place for writers to share ideas in order to facilitate an ongoing conversation. At the end of the day, misinformation affects all of us. We like to make ideas and blogs more than just a branding corner to advocate for our own accomplishments. We want you to think of this blog as a living document part of a long conversation and all of us are at the dinner table. This blog will be one infinite scroll where the first conversation is at the bottom, building the foundation for the last one at the top. Check in from time-to-time and drop a line if you want to post a short guest conversation to help facilitate the direction of our ongoing conversation. We hope you'll take this journey with us and we look forward to taking the trip. It's going to be a wild ride.</p>
                        </div>
                     </div>
                  </div>
         </section>
         ...
         <center>
         <div class="thecuratedflow_img_area">
                        <img src="./static/images/blogpost4.png" alt="blogpost3" class="img-fluid">
                     </div>
                     </center>
            <div class="container">
               <div class="privacy_wrap">
         ...
         <center>
         <div class="thecuratedflow_img_area">
                        <img src="./static/images/blogpost3.png" alt="blogpost3" class="img-fluid">
                     </div>
                     </center>
            <div class="container">
               <div class="privacy_wrap">
         ...
         <center>
         <div class="thecuratedflow_img_area">
                        <img src="./static/images/blogpost2.png" alt="blogpost2" class="img-fluid">
                     </div>
                     </center>
            <div class="container">
               <div class="privacy_wrap">
